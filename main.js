console.log("Hello, beautiful - from the main.js")
...
const newSonnet = sonnet.replace(/winter/g, "yuletide");
console.log(newSonnet);


const anotherSonnet = sonnet.replace(/the/g, "a large");
console.log(anotherSonnet);
